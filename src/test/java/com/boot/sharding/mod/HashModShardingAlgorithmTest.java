...
public final class HashModShardingAlgorithmTest {
    ...
    @BeforeEach
    public void setup() {
        shardingAlgorithm = (HashModShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "HASH_MOD", PropertiesBuilder.build(new Property("sharding-count", "4")));
    }
