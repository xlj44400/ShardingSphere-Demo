...
package com.boot.sharding.mod;

import com.boot.sharding.util.ShardingAlgorithmInitializationException;
...
public final class ModShardingAlgorithmTest {
    ...
    public void assertPreciseDoShardingWithIntShardingValue() {
        ModShardingAlgorithm algorithm = (ModShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "MOD", PropertiesBuilder.build(new Property("sharding-count", "16")));
    ...
    public void assertPreciseDoShardingWithValueIsBigIntegerAndZeroPadding() {
        ModShardingAlgorithm algorithm = (ModShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "MOD", createZeroPaddingProperties());
  ...
  //  @Test(expected = ShardingAlgorithmInitializationException.class)
    ...
    public void assertRangeDoShardingWithWrongArgumentForStartOffset() {
        ...
        ModShardingAlgorithm algorithm = (ModShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "MOD", props);
        assertThat(algorithm.doSharding(createAvailableIncludeZeroTargetNames(), new PreciseShardingValue<>("t_order", "order_id", DATA_NODE_INFO, "12345678910111213141516")), is("t_order_07"));
    }
