...
public final class AutoIntervalShardingAlgorithmTest {
    ...
    @BeforeEach
    public void setup() {
        shardingAlgorithm = (AutoIntervalShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "AUTO_INTERVAL",
    ...
    public void assertGetAutoTablesAmount() {
        ...
        assertThat(((AutoIntervalShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "AUTO_INTERVAL", props)).getAutoTablesAmount(), is(368));
    }
    ...
    public void assertRangeDoShardingWithGreaterTenTables() {
        ...
        AutoIntervalShardingAlgorithm shardingAlgorithm = (AutoIntervalShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "AUTO_INTERVAL", props);
