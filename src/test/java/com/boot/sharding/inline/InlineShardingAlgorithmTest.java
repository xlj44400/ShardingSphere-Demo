...
package com.boot.sharding.inline;
...
public final class InlineShardingAlgorithmTest {
    ...
    @BeforeEach
    public void setUp() {
        inlineShardingAlgorithm = (InlineShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "INLINE",
        ...
        inlineShardingAlgorithmWithSimplified = (InlineShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "INLINE",
                PropertiesBuilder.build(new Property("algorithm-expression", "t_order_${order_id % 4}")));
        negativeNumberInlineShardingAlgorithm = (InlineShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "INLINE",
