...
package com.boot.sharding.classbased;

import com.boot.sharding.util.PropertiesBuilder;
import com.boot.sharding.util.PropertiesBuilder.Property;
import com.boot.sharding.util.fixture.ClassBasedComplexKeysShardingAlgorithmFixture;
import com.boot.sharding.util.fixture.ClassBasedHintShardingAlgorithmFixture;
import com.boot.sharding.util.fixture.ClassBasedStandardShardingAlgorithmFixture;
...
public final class ClassBasedShardingAlgorithmTest {
   ...
   // @Test(expected = ShardingAlgorithmInitializationException.class)
    public void assertInitWithNullStrategy() {
        TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "CLASS_BASED");
    }
    
   // @Test(expected = IllegalArgumentException.class)
    public void assertInitWithWrongStrategy() {
        TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "CLASS_BASED", PropertiesBuilder.build(new Property("strategy", "wrong")));
    }
    
   // @Test(expected = ShardingAlgorithmInitializationException.class)
    public void assertInitWithNullClass() {
        TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "CLASS_BASED", PropertiesBuilder.build(new Property("strategy", "standard")));
    }
    
    //@Test(expected = ClassNotFoundException.class)
    public void assertInitWithUndefinedClass() {
        TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class,
   ...
   // @Test(expected = ShardingAlgorithmClassImplementationException.class)
    ...
    public void assertPreciseDoSharding() {
        ClassBasedShardingAlgorithm algorithm = (ClassBasedShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class,
