...
public final class BoundaryBasedRangeShardingAlgorithmTest {
    ...
    @BeforeEach
    public void setUp() {
        shardingAlgorithm = (BoundaryBasedRangeShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class,
                "BOUNDARY_RANGE", PropertiesBuilder.build(new PropertiesBuilder.Property("sharding-ranges", "1,5,10")));
    }
