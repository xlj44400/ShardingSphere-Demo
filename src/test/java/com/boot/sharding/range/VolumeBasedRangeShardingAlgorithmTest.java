...
package com.boot.sharding.range;
...
public final class VolumeBasedRangeShardingAlgorithmTest {
    ...
    @BeforeEach
    public void setUp() {
        shardingAlgorithm = (VolumeBasedRangeShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class, "VOLUME_RANGE", createProperties());
    }
    
    private Properties createProperties() {
        return PropertiesBuilder.build(new PropertiesBuilder.Property("range-lower", "10"),
                new PropertiesBuilder.Property("range-upper", "45"),
                new PropertiesBuilder.Property("sharding-volume", "10"));
    }
    ...
    public void assertGetAutoTablesAmount() {
        ...
        shardingAlgorithm.init(PropertiesBuilder.build(new PropertiesBuilder.Property("range-lower", "10"),
                new PropertiesBuilder.Property("range-upper", "45"),
                new PropertiesBuilder.Property("sharding-volume", "10")));
