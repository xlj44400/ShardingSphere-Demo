...
package com.boot.sharding.hint;

import org.apache.shardingsphere.sharding.algorithm.sharding.hint.HintInlineShardingAlgorithm;
...
public final class HintInlineShardingAlgorithmTest {
    ...
    @BeforeEach
    public void setUp() {
        hintInlineShardingAlgorithm = (HintInlineShardingAlgorithm) TypedSPIRegistry.getRegisteredService(ShardingAlgorithm.class,
